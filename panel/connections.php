            ...
            <?php
                if($log->num_rows > 0) {
                    while($row = $log->fetch_assoc()) {
                        ...
                        $log_ipaddress = $row['ipaddress'];
                        $log_steamid = $row['steamid'];
                        $log_steamid64 = $row['steamid64'];
                        $log_server = $row['server'];
                        $log_serverip = $row['serverip'];
                        $log_steamname = $row['steamname'];
                        $log_attempt = $row['attempt'];
                        $log_date = $row['date'];
                        $log_uid = $row['uid'];
